...
class employeeAppController extends Controller
{
  public function __construct()
  {
    ...
    public function index(Request $request)
    {
        ...
        return view('business.employeeApp.index', compact('employee'));
    }
    ...
    {
        return view('business.employeeApp.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('Business/employee')->with('flash_message', 'employee added!');
    }
    ...
    public function show($id)
    {
        ...
        return view('business.employeeApp.show', compact('employee'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('business.employeeApp.edit', compact('employee'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('Business/employee')->with('flash_message', 'employee updated!');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect('Business/employee')->with('flash_message', 'employee deleted!');
    }
}
